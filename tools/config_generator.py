...
parser.add_argument('--auto-off', type=int, default=14400000, help='Milliseconds to run animation before auto off')
...
def cpp(path):
    ...
    with open(f'{path}config.h', 'w') as file:
        ...
        file.write(line('int', 'AUTO_OFF_MILLIS', args.auto_off))
