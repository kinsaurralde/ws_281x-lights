...
!function(t, e) {
  ...
  return function(t) {
    ...
    function(t, e, n) {
      ...
      t.exports = e = r;
      var p = e.managers = {};
      e.protocol = s.protocol, e.connect = r, e.Manager = n(12),
      e.Socket = n(36)
    },
    function(t, e, n) {
      'use strict';
            ...
            ('/' === t.charAt(0) &&
             ...
             /^(https?|wss?):\/\//.test(t) ||
                 (i('protocol-less url %s', t),
                  t = 'undefined' != typeof e ? e.protocol + '//' + t :
                                                'https://' + t),
             i('parse %s', t), n = o(t)),
        n.port ||
    ...
    function(t, e, n) {
      (function(r) {
        ...
        e.storage = 'undefined' != typeof chrome &&
    ...
    function(t, e, n) {
      ...
      function o(t) {
        ...
        return n.namespace = t, n.enabled = e.enabled(t),
               n.useColors = e.useColors(), n.color = r(t), n.destroy = i,
      ...
      e = t.exports = o.debug = o['default'] = o, e.coerce = p, e.disable = a,
      e.enable = s, e.enabled = c, e.humanize = n(6), e.instances = [],
    ...
    function(t, e, n) {
      ...
      function h(t) {
        return {
          type: e.ERROR, data: 'parser error: ' + t
        }
      }
      var f = n(3)('socket.io-parser'), l = n(8), d = n(9), y = n(10),
          m = n(11);
      e.protocol = 4,
      e.types =
          [
      ...
      e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = r, e.Decoder = a;
    ...
    function(t, e, n) {
      ...
      var o =
          ...
          i = n(13), s = n(36), a = n(8), c = n(7), p = n(38), u = n(39),
          h = n(3)('socket.io-client:manager'), f = n(35), l = n(40),
    ...
    function(t, e, n) {
      function r(t, e) {
        return this instanceof r ?
            (e = e || {}, t && 'object' == typeof t && (e = t, t = null),
             t ? (t = u(t), e.hostname = t.host,
                  e.secure = 'https' === t.protocol || 'wss' === t.protocol,
                  e.port = t.port, t.query && (e.query = t.query)) :
                 e.host && (e.hostname = u(e.host).host),
             this.secure = null != e.secure ? e.secure :
             ...
             this.forceJSONP = !!e.forceJSONP, this.jsonp = !1 !== e.jsonp,
             ...
             this.prevBufferLen = 0, this.policyPort = e.policyPort || 843,
             ...
             this.pfx = e.pfx || null, this.key = e.key || null,
             this.passphrase = e.passphrase || null, this.cert = e.cert || null,
             this.ca = e.ca || null, this.ciphers = e.ciphers || null,
             this.rejectUnauthorized =
                 void 0 === e.rejectUnauthorized || e.rejectUnauthorized,
             this.forceNode = !!e.forceNode,
             this.isReactNative = 'undefined' != typeof navigator &&
                 'string' == typeof navigator.product &&
                 'reactnative' === navigator.product.toLowerCase(),
             ('undefined' == typeof self || this.isReactNative) &&
                 (e.extraHeaders && Object.keys(e.extraHeaders).length > 0 &&
             ...
             this.pingTimeoutTimer = null, void this.open()) :
            new r(t, e)
      }
      function o(t) {
        var e = {};
      ...
      var i = n(15), s = n(8), a = n(3)('engine.io-client:socket'), c = n(35),
          p = n(21), u = n(2), h = n(29);
      t.exports = r, r.priorWebsocketSuccess = !1, s(r.prototype),
      r.protocol = p.protocol, r.Socket = r, r.Transport = n(20),
      r.transports = n(15), r.parser = n(21),
      r.prototype.createTransport = function(t) {
        ...
        if ('opening' === this.readyState || 'open' === this.readyState ||
          ...
          clearTimeout(this.pingIntervalTimer),
              ...
              this.emit('close', t, e), n.writeBuffer = [], n.prevBufferLen = 0
        }
    ...
    function(t, e, n) {
      function r(t) {
        ...
        if (t.xdomain = n, t.xscheme = r, e = new o(t),
    ...
    function(t, e, n) {
      ...
      function i(t) {
        ...
        this.enablesXDR = t.enablesXDR, this.requestTimeout = t.requestTimeout,
        this.pfx = t.pfx, this.key = t.key, this.passphrase = t.passphrase,
        this.cert = t.cert, this.ca = t.ca, this.ciphers = t.ciphers,
      ...
      var a = n(16), c = n(19), p = n(8), u = n(30),
          h = n(3)('engine.io-client:polling-xhr');
      if (t.exports = o, t.exports.Request = i, u(o, c),
          ...
          i.prototype.create =
              function() {
                ...
                t.pfx = this.pfx, t.key = this.key,
                t.passphrase = this.passphrase, t.cert = this.cert,
                t.ca = this.ca, t.ciphers = this.ciphers,
                t.rejectUnauthorized = this.rejectUnauthorized;
          ...
          i.prototype.hasXDR =
              function() {
                return 'undefined' != typeof XDomainRequest && !this.xs &&
                    this.enablesXDR
              },
          i.prototype.abort =
              function() {
    ...
    function(t, e, n) {
      ...
      var o = n(20), i = n(29), s = n(21), a = n(30), c = n(31),
    ...
    function(t, e, n) {
      function r(t) {
        ...
        this.rejectUnauthorized = t.rejectUnauthorized,
        this.forceNode = t.forceNode, this.isReactNative = t.isReactNative,
    ...
    function(t, e, n) {
      ...
      var v = e.packets = {
        ...
        noop: 6
          ...
          b = u(v), w = {type: 'error', data: 'parser error'}, k = n(28);
      e.encodePacket = function(t, e, n, i) {
        ...
        return void 0 !== t.data &&
                   (c += n ? d.encode(String(t.data), {strict: !1}) :
                             String(t.data)),
               i('' + c)
        ...
        try {
          ...
          for (var a = new Uint8Array(t.data), c = new Array(a.length), p = 0;
               p < a.length; p++)
            c[p] = a[p];
        ...
        function r(t, n) {
          e.encodePacket(t, !0, !0, function(t) {
            ...
            for (var i = t instanceof ArrayBuffer ? t.byteLength : t.size,
                     s = i.toString(), a = new Uint8Array(s.length + 1), o = 0;
                 o < s.length; o++)
              a[o] = parseInt(s[o]);
            if (a[s.length] = 255, k) {
    ...
    function(t, e, n) {
      function r(t) {
        ...
        if ('function' == typeof Buffer && Buffer.isBuffer &&
                Buffer.isBuffer(t) ||
    ...
    function(t, e) {
      ...
      function o(t, e) {
        if (t >= 55296 && t <= 57343) {
          if (e)
            throw Error(
                'Lone surrogate U+' + t.toString(16).toUpperCase() +
      ...
      function s(t, e) {
        ...
        return 0 == (4294965248 & t) ?
                   n = d(t >> 6 & 31 | 192) :
                   0 == (4294901760 & t) ?
                   (o(t, e) || (t = 65533), n = d(t >> 12 & 15 | 224),
                    n += i(t, 6)) :
                   0 == (4292870144 & t) &&
                           (n = d(t >> 18 & 7 | 240), n += i(t, 12),
                            n += i(t, 6)),
                   n += d(63 & t | 128)
      }
      function a(t, e) {
        e = e || {};
        for (var r, o = !1 !== e.strict, i = n(t), a = i.length, c = -1, p = '';
             ++c < a;)
          r = i[c], p += s(r, o);
        return p
      }
    ...
    function(t, e, n) {
     ...
     i.prototype.doClose = function() {
       ...
       if (!this.form) {
         ...
         s.style.top = '-1000px', s.style.left = '-1000px', s.target = c,
    ...
    function(t, e, n) {
      function r(t) {
        ...
        e && (this.supportsBinary = !1),
            ...
            this.protocols = t.protocols, this.usingBrowserWebSocket || (l = i),
            s.call(this, t)
      }
      var o, i, s = n(20), a = n(21), c = n(29), p = n(30), u = n(31),
      ...
      var l = o || i;
      t.exports = r, p(r, s), r.prototype.name = 'websocket',
      r.prototype.supportsBinary = !0, r.prototype.doOpen = function() {
        if (this.check()) {
          ...
          n.pfx = this.pfx, n.key = this.key, n.passphrase = this.passphrase,
          n.cert = this.cert, n.ca = this.ca, n.ciphers = this.ciphers,
          n.rejectUnauthorized = this.rejectUnauthorized,
          this.extraHeaders && (n.headers = this.extraHeaders),
          this.localAddress && (n.localAddress = this.localAddress);
          try {
            this.ws = this.usingBrowserWebSocket && !this.isReactNative ?
                e ? new l(t, e) : new l(t) :
                new l(t, e, n)
          } catch (r) {
        ...
        this.port &&
            ...
            this.supportsBinary || (t.b64 = 1), t = c.encode(t),
                                                t.length && (t = '?' + t);
        var r = this.hostname.indexOf(':') !== -1;
        return e + '://' + (r ? '[' + this.hostname + ']' : this.hostname) + n +
            this.path + t
    ...
    function(t, e, n) {
      ...
      function r(t, e, n) {
        ...
        this.connected = !1, this.disconnected = !0, this.flags = {},
      ...
      var o =
          ...
          i = n(7), s = n(8), a = n(37), c = n(38), p = n(39),
          u = n(3)('socket.io-client:socket'), h = n(29), f = n(23);
      t.exports = e = r;
      var l = {
        connect: 1,
        connect_error: 1,
      ...
      s(r.prototype), r.prototype.subEvents = function() {
        ...
        'function' == typeof e ?
            (u('calling ack %s with %j', t.id, t.data), e.apply(this, t.data),
