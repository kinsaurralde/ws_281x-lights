...
all:
	...
	# Create Version
	touch ${BUILD_DIR}esp8266/version.h
	printf "// This file is generated by 'make build' and should not be edited\n\n" > ${BUILD_DIR}esp8266/version.h
	printf "#define MAJOR ${MAJOR}\n#define MINOR ${MINOR}\n#define PATCH ${PATCH}\n\n" >> ${BUILD_DIR}esp8266/version.h
	printf "#define ESP_HASH \"${ESP_HASH}\"\n#define RPI_HASH \"${RPI_HASH}\"\n" >> ${BUILD_DIR}esp8266/version.h
	cp ${BUILD_DIR}esp8266/version.h ${BUILD_DIR}raspberrypi/src/version.h
	cp ${BUILD_DIR}esp8266/version.h ${CONTROLLERS_DIR}version.h
